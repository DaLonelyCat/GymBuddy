...
public class ExerciseList {
    ...
    public static ArrayList<Exercise> getAllExercises() {
        ...
        list.add(new Exercise(
                ...
                R.drawable.pushup, // Uses the placeholder below
                "Turunkan badan...",
                new ArrayList<>(Arrays.asList("Bodyweight")), // Equipment Tags
                new ArrayList<>(Arrays.asList("Chest", "Arm", "Core")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                R.drawable.dbbenchpress,
                "Berbaring di bench...",
                new ArrayList<>(Arrays.asList("Dumbbell", "Bench")),
                new ArrayList<>(Arrays.asList("Chest", "Arm")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                new ArrayList<>(Arrays.asList("Barbell")),
                new ArrayList<>(Arrays.asList("Leg", "Core")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                "Dumbbell Curl",
                "Melatih otot bicep",
                R.drawable.seatedbicepcurl,
                "Sit on a bench with your feet flat on the floor...",
                new ArrayList<>(Arrays.asList("Dumbbell")),
                new ArrayList<>(Arrays.asList("Arm")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                new ArrayList<>(Arrays.asList("Dumbbell")),
                new ArrayList<>(Arrays.asList("Shoulder")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                R.drawable.dbbentoverrows,
                "Stand with your feet shoulder-width apart...",
                new ArrayList<>(Arrays.asList("Dumbbell")),
                new ArrayList<>(Arrays.asList("Back", "Biceps")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                R.drawable.inclinedbbchestpress,
                "Set an incline bench to a moderate angle...",
                new ArrayList<>(Arrays.asList("Dumbbell", "Bench")),
                new ArrayList<>(Arrays.asList("Arm", "Chest", "Shoulder")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                R.drawable.weightedcrunches,
                "Lie flat on your back...",
                new ArrayList<>(Arrays.asList("Dumbbell")),
                new ArrayList<>(Arrays.asList("Core", "Shoulder")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                R.drawable.barbellseatedcalfraises,
                "Sit on a bench with your feet flat...",
                new ArrayList<>(Arrays.asList("Dumbbell", "Bench")),
                new ArrayList<>(Arrays.asList("Leg")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                R.drawable.pushup, // Ganti nanti gambarnya
        ...
        list.add(new Exercise(
                ...
                new ArrayList<>(Arrays.asList("Barbell")),
                new ArrayList<>(Arrays.asList("Back", "Leg", "Core", "Arm")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                new ArrayList<>(Arrays.asList("Barbell")),
                new ArrayList<>(Arrays.asList("Shoulder", "Arm", "Core")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                new ArrayList<>(Arrays.asList("Bodyweight")),
                new ArrayList<>(Arrays.asList("Back", "Arm", "Core")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                new ArrayList<>(Arrays.asList("Basic Machine")),
                new ArrayList<>(Arrays.asList("Leg")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                new ArrayList<>(Arrays.asList("Bodyweight")),
                new ArrayList<>(Arrays.asList("Core")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                new ArrayList<>(Arrays.asList("Advanced Machine")),
                new ArrayList<>(Arrays.asList("Chest")),
                2,
                12
        ));
        ...
        list.add(new Exercise(
                ...
                new ArrayList<>(Arrays.asList("Bench")),
                new ArrayList<>(Arrays.asList("Back", "Core")),
                2,
                12
        ));
        ...
        // 29. Dumbbell Goblet Squat (Alat: Dumbbell | Otot: Leg, Core)
        list.add(new Exercise(
                18,
                "Dumbbell Goblet Squat",
                "Squat yang bagus untuk pemula, membantu menjaga postur tegak",
                R.drawable.dbgobletsquat,
        ...
        list.add(new Exercise(
                ...
                new ArrayList<>(Arrays.asList("Basic Machine")),
                new ArrayList<>(Arrays.asList("Shoulder", "Back")),
                2,
                12
        ));
